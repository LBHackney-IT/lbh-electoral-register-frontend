...
const Radio = ({
  ...
  >
    <label className={`govuk-label lbh-label govuk-label--${labelSize} radios-label-extra-margin`} htmlFor={name}>
    ...
    <div
      className={cx('govuk-radios lbh-radios', { 'govuk-radios--inline': isRadiosInline })}
    >
      {options.map((option) => {
        const { value, text } =
